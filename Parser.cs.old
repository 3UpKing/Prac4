...
public class Parser {
	...
	public const int _pageNumber = 2;
	// terminals
	public const int EOF_SYM = 0;
	public const int word_Sym = 1;
	public const int pageNumber_Sym = 2;
	public const int comma_Sym = 3;
	public const int lparen_Sym = 4;
	public const int rparen_Sym = 5;
	public const int NOT_SYM = 6;
	// pragmas
	...
	static void Index() {
		while (la.kind == word_Sym || la.kind == lparen_Sym) {
			Line();
		}
		Expect(EOF_SYM);
	}
...
public class Errors {
	...
	public static void SynErr (int line, int col, int n) {
		...
		switch (n) {
			...
			case 2: s = "pageNumber expected"; break;
			case 3: s = "\",\" expected"; break;
			case 4: s = "\"(\" expected"; break;
			case 5: s = "\")\" expected"; break;
			case 6: s = "??? expected"; break;
			case 7: s = "invalid Title"; break;
